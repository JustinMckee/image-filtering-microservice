...
The application will upload images to a cloud database hosted in AWS. Node.js REST API endpoint in a backend service processes incoming image URLs. Deployed on AWS Elastic Beanstalk. 
